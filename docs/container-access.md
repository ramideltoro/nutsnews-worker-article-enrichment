...
Image: `ghcr.io/ramideltoro/nutsnews-worker-article-enrichment:<commit-sha>`

The publish workflow validates the service, builds the Dockerfile, signs the image, and pushes immutable SHA-tagged images. It does not publish mutable `latest` tags.
